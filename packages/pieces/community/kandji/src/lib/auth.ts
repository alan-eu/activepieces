...
4. Click **Configure** and enable the permissions your flows need. Nothing is enabled by default: for the actions in this piece, turn on *Device list*, *Device details*, *Application list*, *Update a device*, *Lock device*, *Get unlock PIN*, *Update inventory*, *Create note*, *Blueprint list* and *User list*. The New Activity Event trigger also needs *List audit events*.
